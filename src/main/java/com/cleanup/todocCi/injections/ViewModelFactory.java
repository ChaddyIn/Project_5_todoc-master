...
import com.cleanup.todocCi.ui.TaskViewModel;
...
public class ViewModelFactory implements ViewModelProvider.Factory {
    ...
    public ViewModelFactory(TaskDataRepository itemDataSource, ProjectDataRepository userDataSource, Executor executor) {
